...
public:
    void Push(T value); // предназначен для добавления узла на вершину стека
                        // принимает на вход новое значения из вершины стека и ничего не возвращает
    ...
    //добавляем конструкторы и операторы
...
T Stack<T>::Pop()
{
    ...
    return return_value; // возвращаем значение новой вершины стека
}
